...
class CacheOptimizerTest extends AbstractCacheOptimizerTest {
	...
	public function contentChangeClearsCacheForContainingPage() {
		...
		$this->actionService->modifyRecord('tt_content', self::CONTENT_UID_SIMPLE, array('header' => 'referenced_content_mod'));
	...
	public function fileMetadataChangeClearsCacheForPagesReferencingToTheDirectory() {
		...
		$this->actionService->modifyRecord('sys_file_metadata', self::FILE_METADATA_UID_REFERENCED_IN_DIRECTORY, array('title' => 'testtitle_referenced'));
	...
	public function fileMetadataChangeClearsCacheForPagesReferencingToTheFile() {
		...
		$this->actionService->modifyRecord('sys_file_metadata', self::FILE_METADATA_UID_REFERENCED, array('title' => 'testtitle_referenced_in_dir'));
	...
	public function pageChangeClearsCacheForRelatedMenusOnDifferentLevel() {
		...
		$this->actionService->modifyRecord('pages', self::PAGE_UID_REFERENCED_IN_MENU_IN_SUBLEVEL, array('title' => 'page_referenced_in_menu_modified'));
	...
	public function pageChangeClearsCacheForRelatedMenusOnSameLevel() {
		$this->fillPageCache(self::PAGE_UID_CONTAINING_MENU);
		$this->actionService->modifyRecord('pages', self::PAGE_UID_REFERENCED_IN_MENU, array('title' => 'page_referenced_in_menu_modified'));
		$this->assertPageCacheIsEmpty(self::PAGE_UID_CONTAINING_MENU);
	}
	...
	public function recordChangeClearsCacheForPagesContainingRelatedContents() {
		...
		$this->actionService->modifyRecord('tx_cacheopttest_domain_model_record', self::CACHEOPT_RECORD_UID, array('title' => 'testrecord_modified_content'));
	...
	public function recordChangeClearsCacheForPagesContainingRelatedPlugins() {
		...
		$this->actionService->modifyRecord('tx_cacheopttest_domain_model_record', self::CACHEOPT_RECORD_UID, array('title' => 'testrecord_modified_plugin'));
